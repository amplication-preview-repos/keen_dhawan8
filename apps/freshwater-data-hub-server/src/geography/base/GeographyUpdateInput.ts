...
class GeographyUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => DatasetUpdateManyWithoutGeographiesInput,
  })
  @ValidateNested()
  @Type(() => DatasetUpdateManyWithoutGeographiesInput)
  @IsOptional()
  @Field(() => DatasetUpdateManyWithoutGeographiesInput, {
    nullable: true,
  })
...
export { GeographyUpdateInput as GeographyUpdateInput };
