...
class GeographyCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => DatasetCreateNestedManyWithoutGeographiesInput,
  })
  @ValidateNested()
  @Type(() => DatasetCreateNestedManyWithoutGeographiesInput)
  @IsOptional()
  @Field(() => DatasetCreateNestedManyWithoutGeographiesInput, {
    nullable: true,
  })
...
export { GeographyCreateInput as GeographyCreateInput };
